...
;(function () {
  ...
  function initCustomizer() {
    ...
    if (!container) {
      console.error('❌ mural-customizer container not found');
      return;
    }
    ...
    console.log('▶︎ Customizer: product loaded', product);
    ...
    panelsLabel.htmlFor = 'panels-checkbox';
    ...
    function drawPanels() {
      ...
      for (let i=1; i<count; i++) {
        ...
        Object.assign(line.style, {
          position:'absolute', top:`${cb.top}px`,
          left:`${x}px`, height:`${cb.height}px`,
          width:'2px', background:'rgba(255,0,0,0.7)',
          pointerEvents:'none'
        });
